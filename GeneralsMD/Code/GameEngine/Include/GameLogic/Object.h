...
//INTO A new Drawable::getHealthBox..() WHICH USES GEOM0INFO, MODEL DATA, INI DATA, ETC.
  ...
  // note, the !=0 at the end is important, to convert this into a boolean type! (srj)
	...
	void setWeaponRangeMultiplier(Real mult) { m_weaponRangeMultiplier = mult; }
	Real getWeaponRangeMultiplier() const { return m_weaponRangeMultiplier; }
...
private:
	...
	Real					m_weaponRangeMultiplier;					///< Runtime weapon range multiplier (default 1.0). Applied in Weapon::getAttackRange.
