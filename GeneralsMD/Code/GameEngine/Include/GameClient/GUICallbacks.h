...
// Archipelago Shell ------------------------------------------------------------------------------
extern void ArchipelagoHubInit( WindowLayout *layout, void *userData );
extern void ArchipelagoHubUpdate( WindowLayout *layout, void *userData );
extern void ArchipelagoHubShutdown( WindowLayout *layout, void *userData );
extern WindowMsgHandledType ArchipelagoHubSystem( GameWindow *window, UnsignedInt msg, WindowMsgData mData1, WindowMsgData mData2 );
extern WindowMsgHandledType ArchipelagoHubInput( GameWindow *window, UnsignedInt msg, WindowMsgData mData1, WindowMsgData mData2 );

extern void APConnectInit( WindowLayout *layout, void *userData );
extern void APConnectUpdate( WindowLayout *layout, void *userData );
extern void APConnectShutdown( WindowLayout *layout, void *userData );
extern WindowMsgHandledType APConnectSystem( GameWindow *window, UnsignedInt msg, WindowMsgData mData1, WindowMsgData mData2 );
extern WindowMsgHandledType APConnectInput( GameWindow *window, UnsignedInt msg, WindowMsgData mData1, WindowMsgData mData2 );

extern void APMissionIntelInit( WindowLayout *layout, void *userData );
extern void APMissionIntelUpdate( WindowLayout *layout, void *userData );
extern void APMissionIntelShutdown( WindowLayout *layout, void *userData );
extern WindowMsgHandledType APMissionIntelSystem( GameWindow *window, UnsignedInt msg, WindowMsgData mData1, WindowMsgData mData2 );
extern WindowMsgHandledType APMissionIntelInput( GameWindow *window, UnsignedInt msg, WindowMsgData mData1, WindowMsgData mData2 );

extern void APCheckTrackerInit( WindowLayout *layout, void *userData );
extern void APCheckTrackerUpdate( WindowLayout *layout, void *userData );
extern void APCheckTrackerShutdown( WindowLayout *layout, void *userData );
extern WindowMsgHandledType APCheckTrackerSystem( GameWindow *window, UnsignedInt msg, WindowMsgData mData1, WindowMsgData mData2 );
extern WindowMsgHandledType APCheckTrackerInput( GameWindow *window, UnsignedInt msg, WindowMsgData mData1, WindowMsgData mData2 );
