...
void PhysicsBehavior::onCollide( Object *other, const Coord3D *loc, const Coord3D *normal )
{
	...
	// Spawned archipelago units pass through allied units (other spawned units and
	// enemy AI units) but still collide with player units (enemies).
	if (TheUnlockableCheckSpawner != nullptr
		&& TheUnlockableCheckSpawner->isEnabled()
