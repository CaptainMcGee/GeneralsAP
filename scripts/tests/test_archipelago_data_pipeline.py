...
def test_pr_scope_audit_contract() -> None:
    ...
    assert scope_audit.is_allowed_file("Core/GameEngineDevice/Source/W3DDevice/GameClient/Drawable/Draw/W3DModelDraw.cpp")
    ...
    assert scope_audit.is_allowed_file("Generals/Code/GameEngine/Include/Common/GlobalData.h")
    assert scope_audit.is_allowed_file("Generals/Code/GameEngine/Include/GameClient/CDCheck.h")
    assert scope_audit.is_allowed_file("Generals/Code/GameEngine/Source/Common/System/CDManager.cpp")
    assert scope_audit.is_allowed_file("GeneralsMD/Code/GameEngine/Source/Common/CommandLine.cpp")
    assert scope_audit.is_allowed_file("GeneralsMD/Code/GameEngine/Include/Common/GlobalData.h")
    assert scope_audit.is_allowed_file("GeneralsMD/Code/GameEngine/Source/Common/GameEngine.cpp")
    assert scope_audit.is_allowed_file("GeneralsMD/Code/GameEngine/Source/Common/GlobalData.cpp")
    assert scope_audit.is_allowed_file("Generals/Code/GameEngine/Source/GameClient/GUI/GUICallbacks/Menus/OptionsMenu.cpp")
    assert scope_audit.is_allowed_file("GeneralsMD/Code/GameEngine/Source/GameClient/GUI/GUICallbacks/Menus/ArchipelagoShell.cpp")
    assert scope_audit.is_allowed_file("GeneralsMD/Code/GameEngine/Source/GameClient/GUI/GUICallbacks/Menus/MainMenu.cpp")
    assert scope_audit.is_allowed_file("GeneralsMD/Code/GameEngine/Source/GameClient/GUI/GUICallbacks/Menus/OptionsMenu.cpp")
    assert scope_audit.is_allowed_file("GeneralsMD/Code/GameEngine/Include/GameLogic/UnlockRegistry.h")
