...
ALLOWED_FILE_PATTERNS = [
    ...
    for pattern in (
        ...
        r"^Data/Archipelago/logic_contracts/(README\.md|capability_sources_schema\.json|mission_gate_schema\.json)$",
        r"^Data/Archipelago/logic_contracts/fixtures/example_logic_contracts\.json$",
