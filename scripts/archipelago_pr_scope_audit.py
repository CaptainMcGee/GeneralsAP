...
ALLOWED_FILE_PATTERNS = [
    ...
    for pattern in (
        ...
        r"^\.github/workflows/check-replays\.yml$",
        ...
        r"^Data/Archipelago/bridge_fixtures/human_demo_(tank|all_generals)\.json$",
        ...
        r"^Core/GameEngineDevice/Source/W3DDevice/GameClient/Drawable/Draw/W3DModelDraw\.cpp$",
        r"^Docs/Archipelago/(Manual-Review-And-Debug-Guide|demo-video-context|demo-video-script)\.md$",
        ...
        r"^GeneralsMD/Code/GameEngine/Include/GameLogic/(Archipelago(SlotData|State)|UnlockRegistry)\.h$",
        ...
        r"^Generals/Code/GameEngine/Source/GameClient/GUI/GUICallbacks/Menus/OptionsMenu\.cpp$",
        r"^GeneralsMD/Code/GameEngine/Source/GameClient/GUI/GUICallbacks/Menus/(ArchipelagoShell|MainMenu|OptionsMenu|ScoreScreen)\.cpp$",
        r"^GeneralsMD/Code/GameEngine/Source/GameLogic/(Archipelago(SlotData|State)|UnlockRegistry)\.cpp$",
        r"^GeneralsMD/Code/GameEngine/Source/GameLogic/Object/Weapon\.cpp$",
        r"^GeneralsMD/Code/GameEngine/Source/GameLogic/System/GameLogic\.cpp$",
        r"^GeneralsMD/Code/GameEngine/Source/GameLogic/UnlockableCheckSpawner\.cpp$",
        r"^scripts/(archipelago_bridge_executable_smoke|archipelago_bridge_local|archipelago_bridge_network_smoke|archipelago_bridge_real_ap_server_smoke|archipelago_extract_ini_config|archipelago_generate_matchup_graph|archipelago_item_location_capacity_report|archipelago_location_catalog_validate|archipelago_logic_contract_validate|archipelago_pr_scope_audit|archipelago_run_checks|archipelago_run_real_ap_smoke|archipelago_runtime_fallback_contract_check|archipelago_seeded_bridge_loop_smoke|archipelago_vendor_capture)\.py$",
        ...
        r"^scripts/windows_(debug_launch|debug_prepare|demo_run)\.ps1$",
        ...
        r"^vendor/archipelago/README\.md$",
        r"^vendor/archipelago/vendor\.json$",
        r"^vendor/archipelago/overlay/worlds/generalszh/.*$",
        r"^vendor/archipelago/upstream/.*$",
    )
]
...
FORBIDDEN_FILE_EXEMPT_PATTERNS = (
    re.compile(r"^vendor/archipelago/upstream/"),
)
...
FORBIDDEN_IMPLEMENTATION_ALLOWED_LINE_RE = re.compile(
    r"planning-only until Hold/Win logic consumes economy floors|not Hold/Win logic",
    re.IGNORECASE,
)
...
def is_forbidden_file_exempt(path: str) -> bool:
    normalized = normalize_path(path)
    return any(pattern.search(normalized) for pattern in FORBIDDEN_FILE_EXEMPT_PATTERNS)
...
def run_scope_audit(base: str, head: str) -> dict[str, object]:
    ...
    forbidden_files = [
        ...
        if FORBIDDEN_FILE_RE.search(path) and not is_forbidden_file_exempt(path)
    ]
