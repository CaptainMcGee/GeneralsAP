...
ALLOWED_FILE_PATTERNS = [
    ...
    for pattern in (
        ...
        r"^Data/Archipelago/bridge_fixtures/human_demo_tank\.json$",
        ...
        r"^scripts/(build_generalsap_bridge_stub|build_generalsap_bridge|package_generalsap_alpha|run_generalsap_demo_director|run_generalsap_nonhuman_release_checks|smoke_generalsap_alpha_package|smoke_generalsap_clean_runtime|validate_generalsap_alpha_package)\.ps1$",
