...
def main() -> int:
    steps = [
        ...
        ("=== Validating future logic contracts ===", SCRIPTS / "archipelago_logic_contract_validate.py", []),
        ("=== Reporting item/location capacity ===", SCRIPTS / "archipelago_item_location_capacity_report.py", []),
