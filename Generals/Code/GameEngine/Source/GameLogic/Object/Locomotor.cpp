...
Real Locomotor::getMaxSpeedForCondition(BodyDamageType condition) const
{
	...
	if( IS_CONDITION_BETTER( condition, TheGlobalData->m_movementPenaltyDamageState ) )
		speed = m_template->m_maxSpeed * m_speedMultiplier;
	else
		speed = m_template->m_maxSpeedDamaged * m_speedMultiplier;
...
Real Locomotor::getMaxAcceleration(BodyDamageType condition) const
{
	...
	if( IS_CONDITION_BETTER( condition, TheGlobalData->m_movementPenaltyDamageState ) )
		accel = m_template->m_acceleration * m_speedMultiplier;
	else
		accel = m_template->m_accelerationDamaged * m_speedMultiplier;
