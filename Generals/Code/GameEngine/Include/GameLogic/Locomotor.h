...
public:
	...
	*/
	...
	void setSpeedMultiplier(Real mult) { m_speedMultiplier = mult; }
...
private:
	...
	Real				m_maxBraking;
	Real				m_maxTurnRate;
	Real				m_speedMultiplier;  ///< Runtime speed multiplier (default 1.0). Applied to template speed in getMaxSpeedForCondition/getMaxAcceleration.
